...
function DeepSpaceBackground() {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none bg-[#020617]">
      ...
      <svg className="absolute inset-0 w-full h-full z-30 opacity-30" style={{ position: 'absolute', width: '300%', height: '300%', left: '-100%', top: '-100%' }}>
